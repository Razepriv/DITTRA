      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <div className="cyber-card p-8 md:p-10">
            <h2 className="text-2xl md:text-3xl font-semibold text-white mb-6">Contact Info</h2>
            <div className="space-y-4 text-gray-200 text-base md:text-lg">
              ...
              <p>
                <a href="mailto:sales@dittra.com" className="text-primary-400 hover:text-primary-300 transition-colors">
                  sales@dittra.com
                </a>
              </p>
              <p>
                <a href="tel:+17373273347" className="text-primary-400 hover:text-primary-300 transition-colors">
                  +17373273347
                </a>
              </p>
            </div>
